...
#define TOKEN_SYMBOL_CODE wasm_evm::symbol_code(TOKEN_SYMBOL_CODE_RAW)
#define TOKEN_CONTRACT wasm_evm::name(TOKEN_CONTRACT_RAW)
#define TOKEN_SYMBOL wasm_evm::symbol(TOKEN_SYMBOL_CODE, TOKEN_PRECISION)
