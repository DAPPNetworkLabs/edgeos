...
namespace wasm_evm {
  ...
  // wasm_evm::datastream<Stream>& operator<< ( wasm_evm::datastream<Stream>& ds, const bigint::checksum256& v ) {
  //     auto bytes = toBin(v);
  //     ds << bytes;
  //     return ds;
  // }
  ...
  //  */
  // template<typename Stream>
  // wasm_evm::datastream<Stream>& operator>> ( wasm_evm::datastream<Stream>& ds, bigint::checksum256& v ) {
