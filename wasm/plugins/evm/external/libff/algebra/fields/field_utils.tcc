...
//     if (n != (1u << logn)) wasm_evm::check(false, "libff::get_root_of_unity: expected n == (1u << logn)");
//     if (logn > FieldT::s) wasm_evm::check(false, "libff::get_root_of_unity: expected logn <= FieldT::s");
